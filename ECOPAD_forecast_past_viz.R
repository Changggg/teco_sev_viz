...
# args[4] is the number of iterations;incorrect;052918
# args[5] is the directory for forcing
...
#added by chang_052918
forcing.data <- read.table(args5, header = T)
currentdate <- as.Date(paste(forcing.data[,1],forcing.data[,2]), format="%Y %j")[length(forcing.data[,1])]
